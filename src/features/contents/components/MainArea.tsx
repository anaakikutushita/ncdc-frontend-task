  ...
  return (
    <main className="flex-1 p-8 flex flex-col gap-6 bg-white overflow-hidden">
      ...
      <div className="flex items-start justify-between border-b pb-4">
        {!isEditingTitle ? (
          <>
            <h1 className="text-3xl font-bold text-gray-900 truncate">{content.title}</h1>
            <button
      ...
      <div className="flex flex-col gap-2">
        <div className="flex justify-between items-center">
          <h2 className="text-lg font-bold text-gray-700">本文</h2>
          {!isEditingBody && (
            <button
        ...
        {!isEditingBody ? (
          <div className="h-[400px] overflow-y-auto p-4 bg-gray-50 rounded border border-gray-200 whitespace-pre-wrap text-gray-800">
            {content.body}
          </div>
        ) : (
          <div className="flex flex-col gap-2">
